...
export class CustomerUpdateComponent implements OnInit {
    ...
    this.router.params.subscribe(params => {
      ...
      if (id) {
        ...
        this.customerservice.getCustomer(id).subscribe(response => {
          ...
          this.customer_registerForm.patchValue(response.data); // Assuming response.data contains the customer data
        });
      }
    });
  }
  ...
  onupdateCustomer(): void {
    ...
    const customerId = this.customer_registerForm.get('id')?.value; 
    ...
    // if (customerId !== null) { 
      this.customerservice.updateCustomer(customerId, this.customer_registerForm.value).subscribe({
        next: (response) => {
          this.customer_registerResponse = response;
          console.log('Customer update successful:', response);
